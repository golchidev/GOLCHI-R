...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game("GOLCHI STUDIO #7001이 만듬"))
...
@bot.command()
async def 도움(ctx):
    embed = discord.Embed(title = "GOLCHI STUDIO", color = 0x0285FF)
    embed.set_thumbnail(url="https://media.discordapp.net/attachments/845482702211514378/847287612401778729/output-onlinepngtools.png")
    ...
    embed.set_footer(text='GOLCHI STUDIO #7001',
                         icon_url='https://media.discordapp.net/attachments/845482702211514378/847286749825990666/1_2.gif')
...
async def 서버정보(ctx):
    ...
    embed.add_field(name ="서버 지역", value = ctx.guild.region, inline = False)
    embed.add_field(name ="서버 인원 수", value = ctx.guild.member_count, inline = False)
    embed.add_field(name ="서버 주인", value = ctx.guild.owner, inline = False)
    embed.set_footer(text='GOLCHI STUDIO #7001',
                         icon_url='https://media.discordapp.net/attachments/845482702211514378/847286749825990666/1_2.gif')
    await ctx.send(embed=embed)
    ...
    if message.content == ".reset":
        ...
        if userExistance:
            ...
            if levelUp:
                ...
                print("")
                embed = discord.Embed(title = "LvUP!", description = "", color = 0x2FFF00)
                embed.set_thumbnail(url="https://media.discordapp.net/attachments/845482702211514378/847304435691814972/levelup-logo.png?width=1920&height=720")
